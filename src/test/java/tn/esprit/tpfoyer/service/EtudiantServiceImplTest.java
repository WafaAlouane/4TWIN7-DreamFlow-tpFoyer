...
class EtudiantServiceImplTest {
    ...
    void testFindEtudiantByCin() {
        Etudiant etudiant = new Etudiant();
        etudiant.setCinEtudiant(Long.parseLong("12345678"));

        when(etudiantRepository.findEtudiantByCinEtudiant(Long.parseLong("12345678"))).thenReturn(etudiant);

        Etudiant result = etudiantService.recupererEtudiantParCin(Long.parseLong("12345678"));
        assertNotNull(result);
        assertEquals("12345678", result.getCinEtudiant());
        verify(etudiantRepository, times(1)).findEtudiantByCinEtudiant(Long.parseLong("12345678"));
    }

    @Test
    void testFindEtudiantByCinNotFound() {
        when(etudiantRepository.findEtudiantByCinEtudiant(Long.parseLong("12345678"))).thenReturn(null);
